...
n_high, gamma_high, err_high=gamma_toroidal_scan(base_path_high,i_s=190, nsel_max_itg=False, tmin=12000, tmax=30000, n_boxes=4,min_pts_per_box=8,nl_slowingdown=False, nsel_box_err=True, nsel_max_all_space=True)
n_noFLR, gamma_noFLR, err_noFLR=gamma_toroidal_scan(base_path_noFLR,i_s=190, nsel_max_itg=False, tmin=12000, tmax=30000, n_boxes=4,min_pts_per_box=8,nl_slowingdown=False, nsel_box_err=True, nsel_max_all_space=True)

#kperprho_old=n_kperp_convertion_folder(base_path_old, path_ogyropsi)
kperprho_high=n_kperp_convertion_folder(base_path_high, path_ogyropsi, tmin=12000, tmax=30000)
kperprho_noFLR=n_kperp_convertion_folder(base_path_noFLR, path_ogyropsi, tmin=12000, tmax=30000)
...
'''
fig,ax=subplots(figsize=(7,6))
ax.errorbar(n_alexey_lx180, gamma_alexey_lx180, err_alexey_lx180, label='no FLR',marker='o',capsize=5)
ax.errorbar(n_alexey_lx360, gamma_alexey_lx360, err_alexey_lx360, label='no FLR',marker='o',capsize=5)
ax.errorbar(n_alexey_lx540, gamma_alexey_lx540, err_alexey_lx540, label='no FLR',marker='o',capsize=5)


base_path_deltam='/media/test-Samsung-SSD/roma/Work/simulations/lin_ITG_EP/supra/shaped/n_scan/deltam_test/'
n_arr_deltam, gamma_arr_deltam, err_arr_deltam=gamma_toroidal_scan(base_path_deltam,i_s=190, nsel_max_itg=False, tmin=20000, tmax=60000, n_boxes=4,min_pts_per_box=8,nl_slowingdown=False, nsel_box_err=True, nsel_max_all_space=True)
ax.errorbar(n_arr_deltam, gamma_arr_deltam, err_arr_deltam, label='s',marker='o',linewidth=0,capsize=5)
'''